...
class Turboprop(Propulsor):
    """ This is a turboprop. This network is essentially an adaptation of Turbofan.py
    ...
    def evaluate_thrust(self,state):
        ...
        try:
            ...
            shaft_power.inputs.propeller_power                 = propeller.outputs.power ??

            shaft_power(conditions)
        except:
            pass

        # link the low pressure turbine to the propeller
        low_pressure_turbine.inputs.shaft_power_off_take   = shaft_power.outputs

        #get the bypass ratio from the thrust component
        low_pressure_turbine.inputs.bypass_ratio               = 0
