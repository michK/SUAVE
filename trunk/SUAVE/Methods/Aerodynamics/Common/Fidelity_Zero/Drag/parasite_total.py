...
def parasite_total(state,settings,geometry):
    ...
    if propulsors.values()[0]['arch_tag'] == 'conventional': # conventional propulsors
        ...
        for propulsor in propulsors.values():
            ...
            conditions.aerodynamics.drag_breakdown.parasite[propulsor.tag].parasite_drag_coefficient_mech = parasite_drag_mech_tot = parasite_drag_mech * ref_area_mech / vehicle_reference_area * propulsor.nr_engines_mech
            conditions.aerodynamics.drag_breakdown.parasite[propulsor.tag].parasite_drag_coefficient_elec = parasite_drag_elec_tot = parasite_drag_elec * ref_area_elec / vehicle_reference_area * propulsor.nr_engines_elec
